...
| Default: FALSE
*/
$config['email_verification'] = getenv('EMAIL_VERIFICATION') == 'TRUE' ? TRUE : FALSE; //TRUE;
/*
| -------------------------------------------------------------------------
| Email Sender
| -------------------------------------------------------------------------
...
*/
$config['sender_email'] = getenv('SENDER_EMAIL'); //'crebrito@gmail.com';
/*
| -------------------------------------------------------------------------
| Sender Name
| -------------------------------------------------------------------------
...
| Default: any@yoursite.com
*/
$config['sender_name'] = getenv('SENDER_NAME'); //'CI3Starter';
/*
| -------------------------------------------------------------------------
| Email Settings
| -------------------------------------------------------------------------
...
$config['email_settings'] = [
    'smtp_host' => getenv('SMTP_HOST'), //'ssl://smtp.gmail.com', // your smtp host url
    'smtp_port' => getenv('SMTP_PORT'), //'465', // your smtp host port(outgoing). Eg.: 465, 587
    'smtp_user' => getenv('SMTP_USER'), //'crebrito', // your smtp username
    'smtp_pass' => getenv('SMTP_PASS'), //'li19ly73**', // your smtp password
